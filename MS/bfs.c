...
int queue[M], front = 0, end = 0, node_time, component;
...
void dfs_visit(Graphptr graph[], int u){
	...
	printf("%d\tis in component %d\t", u, component);
	node_time++;
